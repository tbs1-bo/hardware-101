...
class OLED:
    ...
    def _config_oled(self):
        """ Initialisation and configuration of SSD1306 for the 128x64 OLED dot matrix"""
        # 00. Display Off AE
        ...
        # self._send_command(0xF1)    # 0xF1: value for pre-charge period
    ...
    def _send_command(self, c):
        ...
        self.i2c.write_byte_data(self.SLAVE_ADDRESS, self.COMMAND_CONTROL_BYTE, c)
